      ...
      {menuOpen && (
        <div className="md:hidden bg-slate-800 border-t border-slate-700/50">
          <div className="flex flex-col gap-4 px-6 py-4">
            <a href="#home" onClick={() => setMenuOpen(false)} className="hover:text-teal-400 transition">Home</a>
            <a href="#about" onClick={() => setMenuOpen(false)} className="hover:text-teal-400 transition">About</a>
            <a href="#projects" onClick={() => setMenuOpen(false)} className="hover:text-teal-400 transition">Projects</a>
            <a href="#contact" onClick={() => setMenuOpen(false)} className="hover:text-teal-400 transition">Contact</a>
          </div>
        </div>
      )}
    </nav>
